...
class AccountList extends Component {
    ...
    render() {
        ...
        <div className="row">
          <div className="col-12">
            <div className={classes.tm_bg_primary_dark}>
              ...
              <select className={classes.custom_select} onChange={this.handlechange}>
       ...
       <div className={classes.tm_content_row}>
           <ChangeAvatar ChangeAvatar={this.state.Accountkeys} Accountvalue={this.state.Accountvalue}/>
           <AccountSettings AccountSettings={this.state.Accountkeys} Accountvalue={this.state.Accountvalue}/>
