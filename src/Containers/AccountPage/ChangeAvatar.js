...
class ChangeAvatar extends Component {
    ...
    readURI(e){
       ...
       if(e.target.files && e.target.files[0]){ console.log(e.target.files[0]);
          ...
          reader.onload = function(e){
            ...
            this.setState({imageURI:e.target.result, profileImg:e.target.result});
          }.bind(this);
        ...
        return (
            ...
            <div className={classes.tm_bg_primary_dark}>
             ...
             <div className={classes.tm_avatar_container}>
               ...
               <img  src={this.state.profileImg} alt="Avatar" className={["img-fluid", "mb-4", classes.tm_avatar].join(' ') }/>
               <a href="#" className={['tm-avatar-delete-link',classes.tm_avatar_delete_link].join(' ')} onClick={this.deletimg}>
                 <i className={["far", "fa-trash-alt", classes.tm_product_delete_icon].join(' ')}></i>
               </a>
             </div>
