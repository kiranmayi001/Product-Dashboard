...
class SelectRole extends Component {
    ...
    handlechange=(e)=>{
        ...
        if( this.state.Accountvalue === ""){
            this.setState({
                Accountkeys: {name:'', email: '', phone: '', profilePic:'', password:''},
    ...
    render = () => {
       ...
       <div className={classes.AccountSelection}>
         <div className={classes.AccountColumnFlex}>
            ...
            <select className={classes.CustomSelect} onChange={(e)=>{this.props.onUserSelect(e.target.value)}}>
            <option className={classes.Option} value="0">Select account</option>
            <option className={classes.Option} value="Admin"   >Admin</option>
            <option className={classes.Option} value="Editor" >Editor</option>
            <option className={classes.Option} value="Merchant" >Merchant</option>
            <option className={classes.Option} value="Customer">Customer</option>
            </select>
            </div>
         </div>
       </div> 
   ...
   <AccountProfilePic   ChangeAvatar={this.state.Accountkeys} Accountvalue={this.state.Accountvalue}/>

    </div>
    {/* <AccountSetting currentUser={this.state.currentUser}/> */}
    <AccountSetting ChangeAvatar={this.state.Accountkeys} Accountvalue={this.state.Accountvalue}/>
     </div>
    </div>
        )
    }
