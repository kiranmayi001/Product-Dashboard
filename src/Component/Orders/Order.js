...
class Order extends Component {
    ...
    getorderdata = ()=>{
        let orderlist = localStorage.getItem('accountdata') === null ? []: JSON.parse(localStorage.getItem('accountdata'));
    ...
    displayorderdata = (data) => {
        ...
        return (
            <tr>
            <th className={classes.thbdy}><b>{data.orderNo}</b></th>
            <td className={classes.thbdy}>
                <div className={className}>
                </div>{data.status}
            </td>
            <td className={classes.thbdy}><b>{data.operators}</b></td>
            <td className={classes.thbdy}><b>{data.location}</b></td>
            <td className={classes.thbdy}><b>{data.distance}</b></td>
